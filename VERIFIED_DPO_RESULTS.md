...
On the same 100 untouched final seeds, β=0.1 changed task success from 92.0% to 100.0%, clean success from 8.0% to 22.0%, and captures per episode from 8.94 to 4.94. This supports a closed-loop safety gain without sacrificing task success in this frozen ID protocol.
