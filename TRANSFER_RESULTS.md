...
The animation uses the predetermined first final seed (`42000`) as a qualitative illustration; all claims and confidence intervals come from the 100-seed aggregate.
