"""Minimal LoRA DPO adaptation of MiniMind's train_dpo loss for verified skill pairs."""
...
def make_model(config, base_weight: Path, sft_lora_weight: Path, device, *, trainable: bool):
