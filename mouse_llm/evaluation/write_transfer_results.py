...
def main() -> None:
    ...
    lines = [
        ...
        "seen versus unseen instruction templates. Goal-only completes with one capture; "
        "seen-instruction MiniMind visits all goals but times out before returning with 33 "
        "captures; unseen-instruction MiniMind completes no goals and records 50 captures. "
        "This is qualitative—claims and intervals come from the 100-seed aggregate.",
        "",
        *table,
        "",
